...
1. [](resources/pods.md)
1. [](resources/replica-sets.md)
1. [](resources/deployments.md)
1. [](resources/services.md)
1. [](resources/services-clusterip.md)
1. [](resources/services-nodeport.md)
1. [](resources/services-loadbalancer.md)

## Video

The articles in the reading section started out as course notes of this excellent Kubernetes course on YouTube:
